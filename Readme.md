...
|:---------|:--------------------|:--------------|:------------|
| 6.1.70   | zynqmp-fpga-generic | 1             | [6.1.70-zynqmp-fpga-generic-1](https://github.com/ikwzm/ZynqMP-FPGA-Linux-Kernel-6.1/tree/6.1.70-zynqmp-fpga-generic-1) |
...
```console
shell$ export RELEASE_TAG=6.1.70-zynqmp-fpga-generic-1
