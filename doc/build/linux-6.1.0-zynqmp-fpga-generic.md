...
```console
shell$ git tag -a 6.1.0-zynqmp-fpga-generic-1 -m "release 6.1.0-zynqmp-fpga-generic-1"
...
```console
shell$ cp arch/arm64/boot/Image.gz ../vmlinuz-6.1.0-zynqmp-fpga-generic-1
shell$ cp .config             ../files/config-6.1.0-zynqmp-fpga-generic-1
```

### Install devicetree to this repository

```console
shell$ install -d ../devicetrees/6.1.0-zynqmp-fpga-generic-1
shell$ cp arch/arm64/boot/dts/xilinx/* ../devicetrees/6.1.0-zynqmp-fpga-generic-1
```
