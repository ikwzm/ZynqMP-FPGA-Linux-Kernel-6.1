...
```console
shell$ git tag -a 6.1.70-zynqmp-fpga-generic-5 -m "release 6.1.70-zynqmp-fpga-generic-5"
...
```console
shell$ cp arch/arm64/boot/Image.gz ../vmlinuz-6.1.70-zynqmp-fpga-generic-5
shell$ cp .config             ../files/config-6.1.70-zynqmp-fpga-generic-5
```
